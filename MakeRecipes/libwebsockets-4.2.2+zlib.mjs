// RUN wget https://raw.githubusercontent.com/yacubin/PkgExtras/refs/heads/develop/MakeRecipes/libwebsockets-4.2.2+zlib.mjs
// RUN npm init -y
// RUN npm install bitmake
// RUN npx bitmake build --config libwebsockets-4.2.2+zlib.mjs
