...
if (LibNetQ_FOUND AND NOT TARGET LibNetQ::LibNetQ)
  add_library(LibNetQ::LibNetQ INTERFACE IMPORTED)
  set_property(TARGET LibNetQ::LibNetQ PROPERTY INTERFACE_COMPILE_DEFINITIONS "${LibNetQ_DEFINITIONS}")
  set_property(TARGET LibNetQ::LibNetQ PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${LibNetQ_INCLUDE_DIRS}")
  set_property(TARGET LibNetQ::LibNetQ PROPERTY INTERFACE_LINK_LIBRARIES ${LibNetQ_LIBRARIES})
endif ()
